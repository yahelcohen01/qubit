  ...
  const childProps: React.HTMLAttributes<HTMLElement> & { ref?: any } = {
    ...
    onMouseEnter: (e: React.MouseEvent<HTMLElement>) => {
      ...
      if (children.props.onMouseEnter) {
        (children.props.onMouseEnter as GenericFunction)(e);
      }
    },
    onMouseLeave: (e: React.MouseEvent<HTMLElement>) => {
      hideTooltip();
      if (children.props.onMouseLeave) {
        (children.props.onMouseLeave as GenericFunction)(e);
      }
    },
  };
  ...
  if (showOnFocus) {
    childProps.onFocus = (e: React.FocusEvent<HTMLElement>) => {
      ...
      if (children.props.onFocus) {
        (children.props.onFocus as GenericFunction)(e);
      }
    };
    ...
    childProps.onBlur = (e: React.FocusEvent<HTMLElement>) => {
      ...
      if (children.props.onBlur) {
        (children.props.onBlur as GenericFunction)(e);
      }
    };
  }
